...
/** Comfortable centered Dialog on tablet/laptop/desktop, full-height bottom Sheet on phone. */
export function ResponsiveModal({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        className={cn(
          "flex max-h-[90vh] w-[calc(100%-2rem)] flex-col gap-0 overflow-hidden rounded-2xl p-0 sm:max-w-xl",
          dialogClassName
        )}
      >
