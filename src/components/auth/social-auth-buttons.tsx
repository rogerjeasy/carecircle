...
/**
 * "Continue with Google / Apple" buttons + the "or continue with email" divider.
 * Shared by the sign-in and sign-up screens. Buttons are gated on NEXT_PUBLIC flags so an
 * unconfigured provider never shows a dead button; the server action (socialSignIn) is the
...
// opt-in (it needs a paid Apple Developer account + a generated client secret).
const enabled = {
